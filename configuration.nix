...
let
  user      = "admin";
  password  = "password";
  hostname  = "69290e57a69fd0ee6da2aa28";
  homeDir   = "/home/${user}";
  ...
  hardware = {
    ...
    deviceTree = {
      ...
      overlays = [
        {
          name = "spi1-3cs";
          dtboFile = "${pkgs.device-tree_rpi.overlays}/overlays/spi1-3cs.dtbo";
        }
        {
          name = "can0";
          dtboFile = "${pkgs.device-tree_rpi.overlays}/overlays/mcp251xfd.dtbo";
          params = {
            "spi0-0" = "";
            interrupt = "25";  # GPIO25
